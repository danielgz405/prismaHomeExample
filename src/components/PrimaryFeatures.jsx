...
import screenshotPayroll from '@/images/prisma.png'
    ...
    >
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          ...
          >
            Solución adaptable y personalizada
          </h2>
          <p className="mt-6 text-lg tracking-tight text-blue-100">
            Es un programa de automatización eficiente que consta de asesorías profesionales, 
            diagnóstico y una solución ajustada a la medida de la empresa.
          </p>
        </div>
        <Tab.Group
          as="div"
