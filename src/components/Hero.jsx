...
export function Hero() {
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-10 lg:pb-22 dark:bg-slate-800">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        ...
        <span className="relative whitespace-nowrap text-teal-600">
          ...
          <span className="relative">PRISMA.</span><br/>
        </span>{' '}
        <span className='dark:text-slate-200'>Una nueva manera de aportar seguridad.</span> 
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700 dark:text-slate-400">
      Prisma te permite el control operativo de tu personal en misión, con lo último en tendencias tecnológicas.
      </p>
      <div className="mt-10 flex justify-center space-x-6">
        ...
        >
          <svg
            aria-hidden="true"
            className="h-3 w-3 flex-none fill-teal-600 group-active:fill-current"
          >
            <path d="m9.997 6.91-7.583 3.447A1 1 0 0 1 1 9.447V2.553a1 1 0 0 1 1.414-.91L9.997 5.09c.782.355.782 1.465 0 1.82Z" />
          </svg>
          <span className="ml-3 dark:text-slate-100">Demo</span>
        </ButtonLink>
      </div>
